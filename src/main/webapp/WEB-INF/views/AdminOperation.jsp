...
<div id="sub-left">
	...
	<table>
		...
		<tr>
			...
			<td><form:select id="hArea" path="hotelArea">
				...
				<form:option value="Marathahalli">Marathahalli</form:option>
				<form:option value="Silk Board">Silk Board</form:option>
			</form:select></td>
	...
	<div id="SingleBedRoom">
		<table>
			<tr>
				<td>SingleBedRoom :</td>
				<td><input type="text" name="OneBeddedRoomNum" required
					display="" /></td>
				</tr>

				<tr>
					<td>Price :</td>
					<td><input type="text" name="TypeOneprice" required /></td>
				</tr>
		...
		<div id="DoubleBedRoom">
			<table>
				<tr>
					<td>DoubleBedRoom:</td>
					<td><input type="text" name="TwoBeddedRoomNum" required /></td>
				</tr>

				<tr>
					<td>Price :</td>
					<td><input type="text" name="TypeTwoprice" required /></td>
				</tr>
...
<div class="myTable">
	...
	<h3 class="headings">To Edit Or Delete Operations Please Double
	Click On Table Row</h3>
	<table id="hoteltable" border="1" align="center">
		<tr class="list">
			<td><h4>Id</h4></td>
			<td><h4>Name</h4></td>
			<td><h4>Area</h4></td>
